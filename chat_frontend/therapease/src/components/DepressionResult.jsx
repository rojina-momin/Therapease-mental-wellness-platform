...
const DepressionResult = ({ depressionLevel, formData, calculateScore }) => {
    
  const videos = [
    { id: 'hAkgumAMOIg', queryParams: 'si=RS7dTboPGx8qeDrb', description: 'Meditation for Depression' },
    { id: 'Bk0lzv8hEU8', queryParams: 'si=-OvYrCRb5uOWgdGk', description: '5 Ways To Deal With Depression' },
    { id: 'xRxT9cOKiM8', queryParams: 'si=PnO3s3MsW7LWcmvv', description: '10-Minute Meditation For Depression' },
  ];
  ...
  return (
    ...
    <div className="  xl:w-[418px] lg:w-[410px] md:w-[388px]  xl:ml-[140px] lg:ml-[50px] md:ml-[10px] ml-4  flex-1  h-screen  overflow-auto xl:px-4 items-center md:sticky top-32" style={{ height: 'fit-content', zIndex: 1 }}>
      <h2 className="lg:text-[22px] text-[18px] font-medium xl:ml-[60px] lg:ml-[30px] md:ml-[30px] ml-[80px] mb-3 ">Am I sad or depressed?</h2>
      <h1 className='lg:text-[15px] md:text-[13px] pl-[30px]  xl:ml-[80px] lg:ml-[50px] md:ml-[30px] ml-[60px]'>Here are your results?</h1>
      <p className='xl:text-[22px]  md:text-[18px] mt-2 xl:ml-[100px] lg:ml-[80px] md:ml-[60px] ml-[100px] text-black font-bold flex'>Your score: <span className='text-red pl-[10px]'>{calculateScore(formData)}</span></p>
      <p className='md:text-[16px] xl:text-[18px] lg:text-[20px] mt-3 font-semibold flex xl:ml-[40px] lg:ml-[20px] md:ml-[20px] md:px-0 px-10'>Depression Level: <span className='text-red pl-[10px] '>{depressionLevel}</span></p>
      <p className='xl:text-[18px] lg:text-[16px] md:text-[12px] text-[14px] lg:w-[430px] md:px-0 px-2  mt-5'>{depressionLevel} of symptoms seen in depression Test</p>
       ...
       <p className='xl:text-[14px] lg:text-[13px] md:text-[11px] text-[12px] text-center py-5  px-6 items-center justify-center'>People who score like you tend to experience few or no signs that are typically seen in depression. You may sometimes feel low, unmotivated or disinterested - but these feelings are likely to pass quickly.</p>
        </div>
