...
const StressResult = ({ stressLevel, formData, calculateScore }) => {
    const videos = [
        { id: 'Ix73CLI0Mo0', queryParams: 'si=Zpxf06981qx2Xm4t', description: 'Meditation for Stress' },
        { id: 'bLpChrgS0AY', queryParams: 'si=EzlMHJwmZfN7oUjz', description: 'How to Practice Mindfulness' },
        { id: 'uNiJW0KMwf4', queryParams: 'si=_Lj63l0hvdVQGhZh', description: 'Guided Meditation for Stress Relief' },
    ...
    <h2 className="lg:text-[22px] text-[18px] font-medium xl:ml-[90px] lg:ml-[60px] md:ml-[50px] ml-[80px] mb-3 ">Do you Feel Stress?</h2>
    ...
    <p className='md:text-[16px] xl:text-[18px] lg:text-[20px] mt-3 font-semibold flex xl:ml-[80px] lg:ml-[50px] md:ml-[20px] ml-[40px] md:px-0 px-10'>Stress Level: <span className='text-red pl-[10px] '>{stressLevel}</span></p>
    <p className='xl:text-[18px] lg:text-[16px] md:text-[12px] text-[14px] lg:w-[430px] md:px-0 px-2 md:ml-0 ml-[20px]  mt-5'>{stressLevel} of symptoms seen in Stress Test</p>
