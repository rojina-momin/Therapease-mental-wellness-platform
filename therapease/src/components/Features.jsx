      ...
      <div className={`flex flex-row lg:mx-5 mx-3 my-4 relative  `}>
        ...
        <div className={`relative  xl:w-[320px] xl:h-[330px] lg:w-[310px] lg:h-[320px] ${bgColor} md:w-[210px] md:h-[190px] w-[250px] h-[250px]  rounded-lg shadow-lg z-10`}>
          <div className="">
            ...
            <img src={img}  className={`xl:w-[240px] xl:h-[240px] mt-4 lg:w-[230px] lg:h-[230px] md:w-[120px] md:h-[120px] relative ${styles.flexCenter}  w-[160px] h-[160px]  ml-12 object-cover`} />
