...
const Step = () => {
  return (
    <div className='pt-[120px]  '>
        <h1 className={`${styles.flexCenter} font-semibold md:text-[38px] mt-15 mb-[-50px] text-[30px]`}>How it works</h1>
    ...
    <div className="flex items-center justify-center lg:mt-[-150px] md:mt-[-100px]">
        ...
        <ArrowDownIcon className="lg:w-[100px] lg:h-[100px] md:w-[80px] md:h-[80px] w-[60px] h-[60px] text-yellow" /> {/* Adjust width and height as needed */}
    </div>
    ...
    <div className={`${layout.sectionInfo} `}>
      ...
      <h1 className={`text-red font-semibold lg:text-[30px] text-[25px] lg:mr-[140px]  `}>Interact with a Chatbot</h1>
    ...
    <div className={layout.sectionImg}>
      <img src={step2} alt="billing" className="w-[90%] h-[90%] xl:ml-[100px]" />
    </div>
    </section>
    ...
    <img src={mango} className='absolute right-0 lg:mt-[-100px] md:mt-[-180px] lg:w-[88px] lg:h-[405px] md:w-[50px] object-cover hidden md:block' />
        <div className="flex items-center justify-center lg:mt-[-150px] md:mt-[-100px] ">
        <ArrowDownIcon className="lg:w-[100px] lg:h-[100px] md:w-[80px] md:h-[80px] w-[60px] h-[60px] md:mt-0 mt-6  text-yellow" /> {/* Adjust width and height as needed */}
      </div>

    <section className={layout.section}>
      <div className={layout.sectionImgReverse}>
      <img src={step3} alt="billing" className="w-[90%] h-[90%] xl:ml-[100px]" />
    </div>
    <div className={layout.sectionInfo}>
      
      <h1 className={`text-faintgray font-semibold lg:text-[30px] text-[25px] md:mt-0 mt-6 lg:mr-[280px] md:mr-[120px]  `}>Get Suggestions</h1>
      
      <p className={`${styles.paragraph} max-w-[470px] mt-4 font-normal items-center lg:text-[28px] text-[20px] leading-normal lg:mr-5 md:ml-0 ml-9   text-black`}>
